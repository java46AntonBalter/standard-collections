...
class ArrayTests {
	 ...
	 * @param <T>
	 * @param array
	 * @return true if there is exactly one swap for getting sorted array examples:
	 *         {1, 2, 3, 10, -1, 5, 6} -> false {1, 2, 3, 5, 6, 10} -> false
	 *         {1,3,2,4, 3, 10} -> false {10, 2, 3, 4, 1} -> true {1, 2, 4, 3, 5,
	 *         10} -> true {1, 5, 3, 4, 2, 10} -> true {"lmn", "ab", "bc", "cd",
	 *         "a"} -> true An Array should contain Comparable elements
	 */
	...
	@Test
	void isOneSwapTest() {
		Integer[][] arrFalse = { { 1, 2, 3, 10, -1, 5, 6 }, { 1, 2, 3, 5, 6, 10 }, { 1, 3, 2, 4, 3, 10 },
				{ 1, 10, 2, 3, 6, 4 }, { 1, 2, 4, 2, 10, 6 }, { 1, 2, 3, 4, 6, 10 } };

		Integer[][] arrTrue = { { 10, 2, 3, 4, 1 }, { 1, 2, 4, 3, 5, 10 }, { 1, 5, 3, 4, 2, 10 }, { 1, 6, 3, 4, 2, 10 },
				{ 1, 2, 4, 3, 6, 10 }, { 10, 2, 3, 4, 6, 1 }, { 3, 2, 3, 4, 6, 10 }, { 1, 2, 3, 4, 6, 10, 7 } };
		for(Integer[] i : arrFalse) {
			assertFalse(isOneSwapForSorted(i));
		}
		for(Integer[] i : arrTrue) {
			assertTrue(isOneSwapForSorted(i));
		}
